...
module.exports = {
  ...
  actions: data => {
    ...
    if (data.wantActionsAndReducer) {
      ...
      actions.push({
        type: 'add',
        path: '../../{{path}}/{{properCase name}}/actions.js',
      ...
      actions.push({
        type: 'add',
        path: '../../{{path}}/{{properCase name}}/constants.js',
      ...
      actions.push({
        type: 'add',
        path: '../../{{path}}/{{properCase name}}/selectors.js',
      ...
      actions.push({
        type: 'add',
        path: '../../{{path}}/{{properCase name}}/reducer.js',
    ...
    if (data.wantSaga) {
      actions.push({
        type: 'add',
        path: '../../{{path}}/{{properCase name}}/saga.js',
