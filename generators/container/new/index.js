...
module.exports = {
  ...
  actions: data => {
    ...
    const actions = [
      {
        type: 'add',
        path: '../../{{path}}/containers/{{properCase name}}/index.js',
    ...
    if (data.wantActionsAndReducer) {
      ...
      actions.push({
        type: 'add',
        path: '../../{{path}}/containers/{{properCase name}}/actions.js',
      ...
      actions.push({
        type: 'add',
        path: '../../{{path}}/containers/{{properCase name}}/constants.js',
      ...
      actions.push({
        type: 'add',
        path: '../../{{path}}/containers/{{properCase name}}/selectors.js',
      ...
      actions.push({
        type: 'add',
        path: '../../{{path}}/containers/{{properCase name}}/reducer.js',
    ...
    if (data.wantSaga) {
      actions.push({
        type: 'add',
        path: '../../{{path}}/containers/{{properCase name}}/saga.js',
    ...
    if (data.wantLoadable) {
      actions.push({
        type: 'add',
        path: '../../{{path}}/containers/{{properCase name}}/Loadable.js',
